...
<!--        <img src="resources/1.bmp" alt="background image"/>-->
    ...
    <div id="navigation-wrapper">
        ...
        <nav id="navigation-bg">
            <ul>
                <li><a href="index.php"><div>Начало</div></a></li>
                <li><a href="guide.php"><div>Наръчник</div></a></li>
                <li><a href="jokes.php"> <div>Бисери</div></a></li>
                <li><a href="gallery.php"> <div>Галерия</div></a></li>
                <li><a href="about.php"><div>За нас</div></a></li>
            </ul>
        </nav>
